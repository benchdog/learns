...
if __name__ == '__main__':
    ...
    line_data += '</table>\n</body>\n</html>'
    lines = []
    with open(html_path + 'relay_stat_zhihuiV2.html',encoding='utf8') as fr:
        for line in fr:
            lines.append(line)
    lines = lines[:29]
    lines[14] = '<h1>市本级智慧社区数据接收统计 ' + today + '</h1>\n'
    lines.append(line_data)
    s = ''.join(lines)
    with open(html_path + 'relay_stat_zhihuiV2.html','w',encoding='utf8') as fw:
        fw.write(s)
